...
/// Configure the pallet-kittkitties in pallets/kittkitties.
impl pallet_kittkitties::Config for Runtime {
	type Event = Event;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		SubstrateKitties: pallet_kittkitties,
	}
);
